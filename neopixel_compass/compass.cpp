...
// Global Variables ----------------------------------------------------------
float compass_x_offset=0, compass_y_offset=0, compass_z_offset=0,compass_gain_fact=1,compass_x_scaled,compass_y_scaled,compass_z_scaled;
...
void compass_heading(){
  ...
  if (compass_y_scaled>0){
    bearing = 90-atan(compass_x_scaled/compass_y_scaled)*compass_rad2degree;
  }else if (compass_y_scaled<0){
    bearing = 270-atan(compass_x_scaled/compass_y_scaled)*compass_rad2degree;
